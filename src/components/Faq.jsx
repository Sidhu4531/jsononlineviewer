const FAQS = [
  ...
  },
  {
    ...
    a: (
      <>
        <p>
          Using our <strong>JSON viewer</strong> is simple.
        </p>
    ...
    <section className="faq" id="faq" aria-label="Frequently asked questions">
      <div className="faq-inner">
        ...
        <p className="faq-lead">
          Everything you need to know about the JSON Online Viewer — what it is, how to use
          it, and how it works in Chrome.
        </p>
